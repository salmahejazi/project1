...
1. **Simple File Storage:** Upload/download/remove file
2. **Note Management:** Add/update/remove text note
...
The home page is the center of the application and hosts the three required pieces of functionality. The existing template presents them as three tabs that can be clicked through by the user:
 ...
 i. File
  - The user should be able to upload file and see any file they previously uploaded. 

  - The user should be able to view/download or delete previously-uploaded file.
  - Any errors related to file actions should be displayed. For example, a user should not be able to upload two file with the same name, but they'll never know unless you tell them!


 ii. Note
  - The user should be able to create note and see a list of the note they have previously created.
  - The user should be able to edit or delete previously-created note.
